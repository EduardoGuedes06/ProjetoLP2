...
def criar_tabelas(banco):
  ...
  try:
    ...
    #---------------------------------------------#
    c.execute("INSERT INTO aluno VALUES ('123','Pedro','524534543','2000-11-11','ADS'),('456','joao','524556745','1998-11-11','ADS'),('789','Felipe','524533343','2004-01-02','ENG'),('112','Paulo','524533459','2007-08-09','ADS');")
    conn.commit()
